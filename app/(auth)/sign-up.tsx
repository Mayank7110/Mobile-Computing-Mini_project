...
const SignUp = () => {
  ...
  const handleBiometricAuth = async () => {
    ...
    const result = await LocalAuthentication.authenticateAsync({ promptMessage: "Authenticate to complete signup" });
    if (result.success) {
  ...
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="flex-1 bg-white">
        ...
        <ReactNativeModal isVisible={verification.state === "pending"} onModalHide={handleBiometricAuth}>
